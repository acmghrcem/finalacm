  ...
  return (
    ...
    >
      <div className="my-3" id="signUpTitle">
        ...
        >
          Join us at <span className="text-blue-800 font-extrabold">ACM</span>
        </motion.h1>
      </div>
      <motion.div
        whileHover={{
      ...
      >
        ...
        <div className="w-full" id="signUpForm">
          <Form.Root onSubmit={handleSignUp}>
            ...
            >
              ...
              >
                ...
                <Form.Control asChild>
                  <motion.input
                    type="email"
                    className="text-white bg-transparent border-[1px] border-blue-800 rounded-full p-2 w-full mt-1"
                    required
                    whileFocus={{
                      boxShadow: "0 0 10px #2563eb",
                    }}
            ...
            >
              <Form.Submit asChild>
                <button className="text-white bg-blue-800 rounded-full w-3/4 p-2 mt-4  font-bold text-center">
                  Register
                </button>
              </Form.Submit>
            </motion.div>
